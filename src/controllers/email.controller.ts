...
import { sendOtpEmail, sendResultEmail, sendLoginNotification, sendOutpassRequestNotification, sendOutingRequestNotification, sendOutpassApprovalNotification, sendOutingApprovalNotification, sendNewRequestAlertToAdmin, sendActionConfirmationToAdmin, sendCheckpointNotification, sendPasswordChangeNotification, sendProfileUpdateNotification } from '../services/email.service';
    ...
    try {
        ...
        switch (type) {
            ...
            case 'password_change':
                ...
                break;
            case 'profile_update':
                success = await sendProfileUpdateNotification(to, data.username, data.updatedFields);
                break;
            default:
