...
This code is valid for 10 minutes. If you did not request this, please ignore this email.${emailFooter()}`;
    ...
    console.log(
      `[MAIL] OTP Sent: ID=${info.messageId}, To=${email}, Res=${info.response}`,
    );
    return true;
  } catch (error) {
...
If you did not perform this action, please contact UniZ administration immediately.${emailFooter()}`;
...
If you did not make these changes, please notify administration.${emailFooter()}`;
